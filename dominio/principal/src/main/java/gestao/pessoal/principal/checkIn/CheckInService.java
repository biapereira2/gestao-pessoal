package gestao.pessoal.principal.checkIn;

import gestao.pessoal.engajamento.progressoUsuario.ProgressoUsuarioService;
import gestao.pessoal.principal.habito.RepositorioHabito; // Adicionado para buscar os pontos do Hábito
import gestao.pessoal.principal.habito.Habito; // Adicionado para buscar os pontos do Hábito

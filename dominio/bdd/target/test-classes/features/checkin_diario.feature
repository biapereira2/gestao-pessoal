Feature: Rastreamento Diário de Hábitos
  ...
  Scenario: 3. Visualizar check-ins de um período (Mês)
    Given que sou um usuário autenticado
    And eu já possuo um hábito cadastrado com o nome "Academia"
    And que o dia da ação é "10/11/2025"
    And o hábito "Academia" tem check-ins registrados nos dias "01/11/2025, 05/11/2025, 10/11/2025"
    When eu solicito a lista de check-ins para o hábito "Academia" no período de "01/11/2025" a "30/11/2025"
    Then eu devo ver uma lista com 3 check-ins

  Scenario: 4. Impedir registro duplicado (Regra de Negócio)
    Given que sou um usuário autenticado
    And eu já possuo um hábito cadastrado com o nome "Ler livro"
    And que o dia da ação é "03/11/2025"
    And o hábito "Ler livro" já está marcado como feito no dia "03/11/2025"
    When eu tento registrar o check-in para o hábito "Ler livro" no dia "03/11/2025"

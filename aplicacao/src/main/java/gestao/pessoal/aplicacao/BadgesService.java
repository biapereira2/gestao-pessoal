...
import gestao.pessoal.habito.RepositorioMeta; // Necessário para verificar metas
import gestao.pessoal.compartilhado.RepositorioUsuario; // Necessário para verificar usuário

...
import gestao.pessoal.habito.RepositorioHabito; // Adicionado para buscar os pontos do Hábito
import gestao.pessoal.habito.Habito; // Adicionado para buscar os pontos do Hábito

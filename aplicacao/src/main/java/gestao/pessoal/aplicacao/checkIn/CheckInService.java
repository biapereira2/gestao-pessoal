...
import gestao.pessoal.habito.habito.RepositorioHabito; // Adicionado para buscar os pontos do Hábito
import gestao.pessoal.habito.habito.Habito; // Adicionado para buscar os pontos do Hábito
